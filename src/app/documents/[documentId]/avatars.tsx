...
const Avatar = ({ src, name }: AvatarProps) => {
  return (
    ...
    >
      <div className="opacity-0 group-hover:opacity-100 absolute top-full py-1 px-2 text-white z-10 text-xs mt-2.5 bg-black whitespace-nowrap transition-opacity">
        {name}
      </div>
